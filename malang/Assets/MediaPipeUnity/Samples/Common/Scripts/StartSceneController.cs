...
namespace Mediapipe.Unity
{
  public class StartSceneController : MonoBehaviour
  {
    ...
    private static string _sceneTitle = "HairColorGame";

    private IEnumerator Start()
    {
      MediaPipeController.visit();//방문처리
      ...
      var sceneLoadReq = SceneManager.LoadSceneAsync(_sceneTitle);
      yield return new WaitUntil(() => sceneLoadReq.isDone);
    }

    public static void ChangeSceneTitle(string title)
    {
      _sceneTitle = title;
    }
  }
