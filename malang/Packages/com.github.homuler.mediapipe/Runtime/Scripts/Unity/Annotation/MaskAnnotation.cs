...
#pragma warning restore IDE0065
  ...
  public class MaskAnnotation : HierarchicalAnnotation
  {
    ...
    public void SetColor(Color color)
    {
      color.a = 0.3f;
      _color = color;
      Debug.Log("SetColor : " + _color.ToString());
    }
    private void OnEnable()
    {
      ApplyMaskTexture(_maskTexture, _color);
      Debug.Log("onEnable : "+ _color.ToString());
    ...
    public void Init(int width, int height)
    {
      ...
      Debug.Log("Init : " + _color.ToString());
      ApplyMaskTexture(_maskTexture, _color);
    ...
    {
      Debug.Log("CreateMonoColorTexture : " + color.ToString());
    ...
    {
      Debug.Log("ApplyMaskTexture : " + maskColor.ToString());
      if (_material != null)
      {
